...
public class Lexer
{
	...
	/**Konstruktor vytvori instanci <code>Lexer</code> nad existujicim <code>
	...
	{
		System.err.println("Chyba na radce " + line + ", pozici " + column + 
				"\n" + msg);
		System.exit(1);
	}
	...
	public static void main(String args[]) throws IOException
	{
		...
		Token token;
		while((token = lexer.nextToken()) != Token.T_EOF)
		{
			String outToken = "<" + elements.get(token);
			
		    if (lexer.getTokenValue() == null)
		    	outToken += ">";
		    else
		    	outToken += ": \"" + lexer.getTokenValue() + "\">";
